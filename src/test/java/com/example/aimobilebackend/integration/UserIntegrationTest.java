...
class UserIntegrationTest {
    ...
    void userLifecycle_shouldWorkEndToEnd() {
        ...
        ResponseEntity<String> updateResponseRaw = restTemplate.exchange(
        ...
        ResponseEntity<UserResponse> updateResponse = restTemplate.exchange(
                baseUrl + "/" + userId + "/username?username=updateduser",
                HttpMethod.PUT, HttpEntity.EMPTY, UserResponse.class);
        ...
        // 4. Get all users
        ResponseEntity<UserResponse[]> getAllResponse = restTemplate.getForEntity(
                baseUrl, UserResponse[].class);
        ...
        ResponseEntity<UserResponse> getDeletedResponse = restTemplate.getForEntity(
                baseUrl + "/" + userId, UserResponse.class);
